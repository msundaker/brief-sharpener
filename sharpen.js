...
For each criterion give a verdict of exactly "sharp", "needs work", or "missing", plus one short, pointed question (max 15 words, one sentence) a senior strategist would ask aloud in the room to sharpen it. Skip the question only if verdict is "sharp" (use empty string).
